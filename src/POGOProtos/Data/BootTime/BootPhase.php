...
namespace POGOProtos\Data\BootTime;

/**
 * Protobuf type <code>POGOProtos.Data.BootTime.BootPhase</code>
 */
class BootPhase
{
    /**
...
class_alias(BootPhase::class, \POGOProtos\Data\BootTime_BootPhase::class);
