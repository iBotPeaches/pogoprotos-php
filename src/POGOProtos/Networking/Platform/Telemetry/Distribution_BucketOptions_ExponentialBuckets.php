...
/**
 * Protobuf type <code>POGOProtos.Networking.Platform.Telemetry.Distribution.BucketOptions.ExponentialBuckets</code>
 */
class Distribution_BucketOptions_ExponentialBuckets extends \Google\Protobuf\Internal\Message
{
    /**
