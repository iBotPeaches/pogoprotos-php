...
/**
 * Protobuf type <code>POGOProtos.Networking.Platform.Responses.GetAvailableSkusAndBalancesResponse.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \POGOProtos\Networking\Platform\Responses\GetAvailableSkusAndBalancesResponse_Status::class);
