...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Platform.Responses.ListLoginActionResponse</code>
 */
class ListLoginActionResponse extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\POGOProtos\Networking\Platform\Responses\ListLoginActionResponse::initOnce();
