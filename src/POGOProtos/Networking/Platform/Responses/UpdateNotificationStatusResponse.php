...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Platform.Responses.UpdateNotificationStatusResponse</code>
 */
class UpdateNotificationStatusResponse extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\POGOProtos\Networking\Platform\Responses\UpdateNotificationStatusResponse::initOnce();
