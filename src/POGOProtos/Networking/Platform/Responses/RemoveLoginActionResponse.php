...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Platform.Responses.RemoveLoginActionResponse</code>
 */
class RemoveLoginActionResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.POGOProtos.Networking.Platform.Responses.RemoveLoginActionResponse.Status status = 3;</code>
     */
    private $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\POGOProtos\Networking\Platform\Responses\RemoveLoginActionResponse::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \POGOProtos\Networking\Platform\Responses\RemoveLoginActionResponse_Status::class);
        $this->status = $var;
