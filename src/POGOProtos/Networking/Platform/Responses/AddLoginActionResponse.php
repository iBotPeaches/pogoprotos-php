...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Platform.Responses.AddLoginActionResponse</code>
 */
class AddLoginActionResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.POGOProtos.Networking.Platform.Responses.AddLoginActionResponse.Status status = 3;</code>
     */
    private $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\POGOProtos\Networking\Platform\Responses\AddLoginActionResponse::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \POGOProtos\Networking\Platform\Responses\AddLoginActionResponse_Status::class);
        $this->status = $var;
