...
/**
 * Protobuf type <code>POGOProtos.Networking.Requests.Messages.RegisterPushNotificationMessage.ApnToken</code>
 */
class RegisterPushNotificationMessage_ApnToken extends \Google\Protobuf\Internal\Message
{
    /**
