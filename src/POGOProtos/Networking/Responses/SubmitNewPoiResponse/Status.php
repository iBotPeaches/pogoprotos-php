...
namespace POGOProtos\Networking\Responses\SubmitNewPoiResponse;

/**
 * Protobuf type <code>POGOProtos.Networking.Responses.SubmitNewPoiResponse.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \POGOProtos\Networking\Responses\SubmitNewPoiResponse_Status::class);
