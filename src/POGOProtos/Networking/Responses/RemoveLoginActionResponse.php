...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Responses.RemoveLoginActionResponse</code>
 */
class RemoveLoginActionResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.POGOProtos.Networking.Responses.RemoveLoginActionResponse.Status status = 3;</code>
     */
    private $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \POGOProtos\Networking\Responses\RemoveLoginActionResponse_Status::class);
        $this->status = $var;
