...
/**
 * Protobuf type <code>POGOProtos.Networking.Responses.DownloadItemTemplatesResponse.Result</code>
 */
class Result
{
    /**
...
class_alias(Result::class, \POGOProtos\Networking\Responses\DownloadItemTemplatesResponse_Result::class);
