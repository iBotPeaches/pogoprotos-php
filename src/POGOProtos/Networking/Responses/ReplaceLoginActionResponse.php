...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Responses.ReplaceLoginActionResponse</code>
 */
class ReplaceLoginActionResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.POGOProtos.Networking.Responses.ReplaceLoginActionResponse.Status status = 3;</code>
     */
    private $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \POGOProtos\Networking\Responses\ReplaceLoginActionResponse_Status::class);
        $this->status = $var;
