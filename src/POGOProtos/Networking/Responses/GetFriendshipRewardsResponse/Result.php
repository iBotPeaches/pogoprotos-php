...
namespace POGOProtos\Networking\Responses\GetFriendshipRewardsResponse;

/**
 * Protobuf type <code>POGOProtos.Networking.Responses.GetFriendshipRewardsResponse.Result</code>
 */
class Result
{
    /**
...
class_alias(Result::class, \POGOProtos\Networking\Responses\GetFriendshipRewardsResponse_Result::class);
