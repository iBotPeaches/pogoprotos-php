...
/**
 * Protobuf type <code>POGOProtos.Networking.Responses.EncounterTutorialCompleteResponse.Result</code>
 */
class Result
{
    /**
    ...
    const SUCCESS = 1;
    /**
     * Generated from protobuf enum <code>ERROR_INVALID_POKEMON = 2;</code>
     */
    const ERROR_INVALID_POKEMON = 2;
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(Result::class, \POGOProtos\Networking\Responses\EncounterTutorialCompleteResponse_Result::class);
