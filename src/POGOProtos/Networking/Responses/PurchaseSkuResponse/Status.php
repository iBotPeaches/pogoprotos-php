...
namespace POGOProtos\Networking\Responses\PurchaseSkuResponse;

/**
 * Protobuf type <code>POGOProtos.Networking.Responses.PurchaseSkuResponse.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \POGOProtos\Networking\Responses\PurchaseSkuResponse_Status::class);
