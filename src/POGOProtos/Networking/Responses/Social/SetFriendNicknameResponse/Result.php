...
namespace POGOProtos\Networking\Responses\Social\SetFriendNicknameResponse;

/**
 * Protobuf type <code>POGOProtos.Networking.Responses.Social.SetFriendNicknameResponse.Result</code>
 */
class Result
{
    /**
...
class_alias(Result::class, \POGOProtos\Networking\Responses\Social\SetFriendNicknameResponse_Result::class);
