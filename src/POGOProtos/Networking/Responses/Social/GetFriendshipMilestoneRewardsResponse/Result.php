...
namespace POGOProtos\Networking\Responses\Social\GetFriendshipMilestoneRewardsResponse;

/**
 * Protobuf type <code>POGOProtos.Networking.Responses.Social.GetFriendshipMilestoneRewardsResponse.Result</code>
 */
class Result
{
    /**
...
class_alias(Result::class, \POGOProtos\Networking\Responses\Social\GetFriendshipMilestoneRewardsResponse_Result::class);
