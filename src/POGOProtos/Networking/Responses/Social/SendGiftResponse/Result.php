...
namespace POGOProtos\Networking\Responses\Social\SendGiftResponse;

/**
 * Protobuf type <code>POGOProtos.Networking.Responses.Social.SendGiftResponse.Result</code>
 */
class Result
{
    /**
...
class_alias(Result::class, \POGOProtos\Networking\Responses\Social\SendGiftResponse_Result::class);
