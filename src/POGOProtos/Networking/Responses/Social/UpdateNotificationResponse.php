...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Responses.Social.UpdateNotificationResponse</code>
 */
class UpdateNotificationResponse extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\POGOProtos\Networking\Responses\Social\UpdateNotificationResponse::initOnce();
