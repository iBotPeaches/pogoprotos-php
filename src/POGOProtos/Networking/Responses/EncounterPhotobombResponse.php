...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Responses.EncounterPhotobombResponse</code>
 */
class EncounterPhotobombResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.POGOProtos.Networking.Responses.EncounterPhotobombResponse.Result result = 1;</code>
     */
    private $result = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\POGOProtos\Networking\Responses\EncounterPhotobombResponse::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \POGOProtos\Networking\Responses\EncounterPhotobombResponse_Result::class);
        $this->result = $var;
