...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Responses.ProxySocialSideChannelActionResponse</code>
 */
class ProxySocialSideChannelActionResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.POGOProtos.Networking.Responses.ProxySocialSideChannelActionResponse.Status status = 1;</code>
     */
    private $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \POGOProtos\Networking\Responses\ProxySocialSideChannelActionResponse_Status::class);
        $this->status = $var;
