...
/**
 * Protobuf type <code>POGOProtos.Networking.Responses.GetAvailableSkusAndBalancesResponse.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \POGOProtos\Networking\Responses\GetAvailableSkusAndBalancesResponse_Status::class);
