...
/**
 * Protobuf type <code>POGOProtos.Networking.Responses.SetFavoritePokemonResponse.Result</code>
 */
class Result
{
    /**
    ...
    /**
     * Generated from protobuf enum <code>ERROR_POKEMON_IS_EGG = 3;</code>
     */
    const ERROR_POKEMON_IS_EGG = 3;
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(Result::class, \POGOProtos\Networking\Responses\SetFavoritePokemonResponse_Result::class);
