...
namespace POGOProtos\Networking\Responses\GetFitnessReportResponse;

/**
 * Protobuf type <code>POGOProtos.Networking.Responses.GetFitnessReportResponse.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \POGOProtos\Networking\Responses\GetFitnessReportResponse_Status::class);
