...
/**
 * Generated from protobuf message <code>POGOProtos.Networking.Responses.PurchaseSkuResponse</code>
 */
class PurchaseSkuResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.POGOProtos.Networking.Responses.PurchaseSkuResponse.Status result = 1;</code>
     */
    private $result = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\POGOProtos\Networking\Responses\PurchaseSkuResponse::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \POGOProtos\Networking\Responses\PurchaseSkuResponse_Status::class);
        $this->result = $var;
